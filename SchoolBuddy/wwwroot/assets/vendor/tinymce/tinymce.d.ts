...
interface ImagePre~/Viewspec extends FormComponentSpec {
    type: 'imagepreview';
    height?: string;
}
...
type BodyComponentSpec = BarSpec | ButtonSpec | CheckboxSpec | TextAreaSpec | InputSpec | ListBoxSpec | SelectBoxSpec | SizeInputSpec | SliderSpec | IframeSpec | HtmlPanelSpec | UrlInputSpec | DropZoneSpec | ColorInputSpec | GridSpec | ColorPickerSpec | ImagePre~/Viewspec | AlertBannerSpec | CollectionSpec | LabelSpec | TableSpec | TreeSpec | PanelSpec | CustomEditorSpec;
interface BarSpec {
    type: 'bar';
    items: BodyComponentSpec[];
}
...
type PublicDialog_d_ImagePre~/Viewspec = ImagePre~/Viewspec;
...
type PublicView_d_~/Viewspec = ~/Viewspec;
type PublicView_d_ViewInstanceApi = ViewInstanceApi;
declare namespace PublicView_d {
    export { PublicView_d_~/Viewspec as ~/Viewspec, PublicView_d_ViewInstanceApi as ViewInstanceApi, };
}
